# ConectaGAB - Documentação Técnica Oficial (Sprint 1 - Versão Enterprise V2)

## 1. Visão Geral (O que é e o que NÃO é)
O ConectaGAB é um protótipo nativo para Android construído como um MVP corporativo focado na experiência de usuário (UX) e demonstração de fluxo tático de Gestão de Projetos e Inovação.
...
- Certifique-se de realizar o *Sync* do Gradle na pasta raiz `ConectaGAB`.
