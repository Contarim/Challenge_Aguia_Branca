# ConectaGAB - Challenge Grupo Águia Branca 🦅🚀

Bem-vindo ao repositório oficial do **ConectaGAB**, a plataforma corporativa de gestão de inovação e projetos desenvolvida para o **Desafio Semestral da FIAP com o Grupo Águia Branca**.

O ConectaGAB é um aplicativo mobile nativo Android desenhado para transformar a forma como as ideias nascem na operação e se tornam projetos de alto impacto (ROI) gerenciados pela diretoria.

---

## 🎯 Objetivo do Projeto
O ConectaGAB foi criado para conectar as pontas da pirâmide corporativa:
...
## 📱 Perfil de Usuários (A Jornada ConectaGAB)
...
O ConectaGAB foi construído do zero focando em uma UI/UX Premium (Enterprise Level) e com arquitetura reativa sólida:
...
👉 **[Acessar a Documentação Técnica Oficial (Documentacao_Tecnica_ConectaGAB.md)](./Documentacao_Tecnica_ConectaGAB.md)**
